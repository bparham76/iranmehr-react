...
import { ShowVisitInfo } from './ShowVisitInfo'

export default function VisitsSearch() {
	const [currentVisitInfo, setCurrentVisitInfo] = useState({})
	const [showCurrentVisitinfo, setShowCurrentVisitInfo] = useState(false)
	...
	const handleShowPatient = patient => {
		setCurrentVisitInfo(patient)
		setShowCurrentVisitInfo(true)
	}
	...
	return (
		<ChildPage>
			{showCurrentVisitinfo && (
				<ShowVisitInfo
					setShow={setShowCurrentVisitInfo}
					patient={currentVisitInfo}
				/>
			)}
